...
describe("Application", () => {
  ...
  it("loads data, books and interview and reduces the spots remaining for the first day by 1", async() => {
    ...
    fireEvent.change(getByPlaceholderText(appointment, /enter student/i), {
  ...
  it("it loads data, edits an interview and keeps the spots remaining for Mondauy the same", async () => {
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    expect(getByText(container, /could not cancel appointment/i)).toBeInTheDocument();
